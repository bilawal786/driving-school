                                ...
                                <div class="card-body">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <p class="fs-14 mb-2">Nombre d'étudiants</p>
                            ...
                            <div class="card avtivity-card">
                                <div class="card-body">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <p class="fs-14 mb-2">Nombre d'instructeurs</p>
                                            <span class="title text-black font-w600">{{$instructor}}</span>
                                        </div>
                                    </div>
                                    <div class="progress" style="height:5px;">
                            ...
                            <div class="card avtivity-card">
                                <div class="card-body">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <p class="fs-14 mb-2">Nombre de cours</p>
                                            <span class="title text-black font-w600">{{$courses}}</span>
                                        </div>
                                    </div>
                                    <div class="progress" style="height:5px;">
