                        ...
                        <div class="profile-tab">
                            <div class="custom-tab-1">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item"><a href="#studentdocument" data-toggle="tab" class="nav-link"><!--CloseJobeRequest-->Document étudiant</a>
                                    </li>
                                                        ...
                                                        <table id="example3" class="display min-w850">
                                                            ...
                                                            @foreach($studentDocument as $row)
                                                                <tr>
                                                                    ...
                                                                    <td>{{$row->title }}</td>
                                                                    <td><a href="{{ route('student.download.url',['id'=>$row->id]) }}"><span style="color: blue;">Télécharger </span></a></td>
