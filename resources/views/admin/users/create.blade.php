                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('students.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('fname') is-invalid @enderror" name="fname" value="{{ old('fname') }}" placeholder="Prénom" required autocomplete="fname" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('lname') is-invalid @enderror" name="lname" placeholder="Nom de famille" value="{{ old('lname') }}" required autocomplete="lname" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="password" class="form-control" placeholder="Confirmez le mot de passe" name="password_confirmation" required autocomplete="new-password">
                            </div>
                        </div>
