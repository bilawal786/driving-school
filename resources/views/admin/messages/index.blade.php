                  ...
                  <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><!-- Developer -->Message d'utilisateur</h4>
                                    ...
                                    <table id="example3" class="display min-w850">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <a href="{{route('message.delete', ['id' => $row->id])}}" id="delete" class="btn btn-danger shadow btn-xs sharp" data-toggle="tooltip" title="Delete">
