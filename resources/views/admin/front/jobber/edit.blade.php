                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><!-- About --> Profil</h4>
                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="POST" action="{{ route('testimonial.update',['id'=>$jobber->id]) }}" enctype="multipart/form-data">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" name="name"  value="{{$jobber->name ?? ''}}"   placeholder="Entrez le nom" >
                                            </div>
                                            <label class="col-sm-2 col-form-label"><!-- job -->Travail  <strong style="color: red;font-size: 20px;"> *</strong></label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" name="job" value="{{$jobber->job ?? ''}}" placeholder="Entrez le Travail " >
                                            </div>
                                        </div>
                                             <div class="form-group row">
                                            <label class="col-sm-3 col-form-label"><!--Icon-->Image(189x188)<strong style="color: red;font-size: 20px;"> * </strong></label>
                                            <div class="col-sm-5">
                      ...
                      <center><i class="fa fa-image"></i> <!-- Add Your Image --> <strong style="font-size: 18px;">Ajoutez Votre Image</strong></center><input type="file" style="display: none;"name="image" value="{{ old('image') }}"  accept="image/png, image/gif, image/jpeg" id="imgInp1" onchange="preview_image1(event)">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div >
                                        <textarea class="summernote" name="description"  >{{$jobber->description}}</textarea>
                                        </div>
                                        </div>
                                    </div>
                                        </div>
