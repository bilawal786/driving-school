...
<div class="row">
    <div class="col-xl-12 col-lg-12">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-4">
            <input type="text" class="form-control" name="courseTitle" value=""  placeholder="Entrez le titre du cours" >
                
            </div>
            <label class="col-sm-2 col-form-label"><!-- Title -->Deatils1 <strong style="color: red;font-size: 20px;"> *</strong></label>
            <div class="col-sm-4">
            <input type="text" class="form-control" name="courseDetails1" value=""  placeholder="Entrez les détails du cours" >
            </div>
        </div>
        <div class="form-group row">
        <label class="col-sm-2 col-form-label"><!-- Title -->Deatils2 <strong style="color: red;font-size: 20px;"> *</strong></label>
            <div class="col-sm-4">
            <input type="text" class="form-control" name="courseDetails2" value=""  placeholder="Entrez les détails du cours" >
            </div>
            <label class="col-sm-2 col-form-label"><!-- Title -->Deatils3 <strong style="color: red;font-size: 20px;"> *</strong></label>
            <div class="col-sm-4">
            <input type="text" class="form-control" name="courseDetails3" value=""  placeholder="Entrez les détails du cours" >
            </div>
        </div>
        ...
        <label class="col-sm-2 col-form-label"><!-- Title -->Deatils4 <strong style="color: red;font-size: 20px;"> *</strong></label>
            <div class="col-sm-4">
            <input type="text" class="form-control" name="courseDetails4" value=""  placeholder="Entrez les détails du cours" >
            </div>
            <label class="col-sm-2 col-form-label"><!-- Title -->Deatils5 <strong style="color: red;font-size: 20px;"> *</strong></label>
            <div class="col-sm-4">
            <input type="text" class="form-control" name="courseDetails5" value=""  placeholder="Entrez les détails du cours" >
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-4">
            <input type="text" class="form-control" name="price" value=""  placeholder="Entrez le Prix" >
