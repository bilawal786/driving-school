                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="POST" action="{{ route('instructor.update',['id'=>$instructor->id]) }}" enctype="multipart/form-data">
                                             @csrf

                                             <div class="form-group row">
                                            <label class="col-sm-2 col-form-label"><!-- Title -->Nom <strong style="color: red;font-size: 20px;"> *</strong></label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" name="name" value="{{$instructor->name}}"  placeholder="Entrez le nom" >
                                            </div>
                                            <label class="col-sm-2 col-form-label"><!-- job -->Travail  <strong style="color: red;font-size: 20px;"> *</strong></label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" name="job" value="{{$instructor->job}}" placeholder="Entrez le Travail " >
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label"><!-- Title -->Facebook <strong style="color: red;font-size: 20px;"> *</strong></label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" name="facebook" value="{{$instructor->facebook}}"  placeholder="Entrez le Facebook" >
                                            </div>
                                            <label class="col-sm-2 col-form-label"><!-- job -->Instagram  <strong style="color: red;font-size: 20px;"> *</strong></label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" name="instagram" value="{{$instructor->instagram}}" placeholder="Entrez le Lien instagram " >
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label"><!-- Title -->La description <strong style="color: red;font-size: 20px;"> *</strong></label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" name="description1" value="{{$instructor->description1}}"  placeholder="Entrez le La description" >
                                            </div>
                      ...
                      <center><i class="fa fa-image"></i> <!-- Add Your Image --> <strong style="font-size: 18px;">Ajoutez Votre Image</strong></center><input type="file" style="display: none;"name="image1" value="{{ old('image1') }}"  accept="image/png, image/gif, image/jpeg" id="imgInp1" onchange="preview_image1(event)">
                                        ...
                                        <img id="output_image1" src="{{asset($instructor->image1)}}" />
                      ...
                      <center><i class="fa fa-image"></i> <!-- Add Your Image --> <strong style="font-size: 18px;">Ajoutez Votre Image</strong></center><input type="file" style="display: none;"name="image2" value="{{ old('image2') }}"  accept="image/png, image/gif, image/jpeg" id="imgInp2" onchange="preview_image2(event)">
                                        ...
                                        <img id="output_image2" src="{{asset($instructor->image2)}}" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div >
                                        <textarea class="summernote" name="description2"  >{{$instructor->description2}}</textarea>
                                        </div>
                                        </div>
                                    </div>
                                        </div>
